 ...
 */
public class GiftFragment extends BaseFragment implements GiftConterContract.DetailedContractView {
    ...
    protected void loadData() {
        ...
        presenter.loadGift(LoginShareUtils.getUserMessage(getContext(), "id"), "1");
    }

    @Override
    public void showGiftDetailed(GiftConterBean giftConterBean) {
        Log.e("===", giftConterBean.toString());
        Log.e("===", giftConterBean.getData().toString());
        Log.e("===", giftConterBean.getData().getSize() + "");
